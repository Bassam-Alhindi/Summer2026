...
class="h-10 w-full rounded-xl border-zinc-800 bg-zinc-900/80 ps-3 pe-14 text-sm text-white focus:border-zinc-700 focus:ring-1 focus:ring-white/20 [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none transition-all"
/>

<!-- Darkened Frosted Glass Stepper Pill -->
<div
class="absolute end-1.5 flex flex-col items-center overflow-hidden rounded-xl opacity-0 pointer-events-none scale-90 transition-all duration-300 ease-out group-focus-within:opacity-100 group-focus-within:pointer-events-auto group-focus-within:scale-100"
style="
background: linear-gradient(135deg, color-mix(in srgb, var(--accent) 20%, rgba(20, 20, 25, 0.85)) 0%, rgba(10, 10, 14, 0.92) 100%);
backdrop-filter: blur(16px) saturate(180%);
-webkit-backdrop-filter: blur(16px) saturate(180%);
border: 1px solid color-mix(in srgb, var(--accent) 40%, rgba(255,255,255,0.15));
box-shadow: 0 8px 20px -4px color-mix(in srgb, var(--accent) 30%, transparent), inset 0 1px 1px 0 rgba(255, 255, 255, 0.2);
"
>
<button
type="button"
...
title="زيادة 50"
>
<ChevronUp class="size-3.5 stroke-[2.5]" style="filter: drop-shadow(0 0 6px var(--accent));" />
</button>

<div
class="h-[1px] w-full"
style="background: color-mix(in srgb, var(--accent) 35%, rgba(255,255,255,0.12));"
></div>
...
title="إنقاص 50"
>
<ChevronDown class="size-3.5 stroke-[2.5]" style="filter: drop-shadow(0 0 6px var(--accent));" />
</button>
</div>
</div>
